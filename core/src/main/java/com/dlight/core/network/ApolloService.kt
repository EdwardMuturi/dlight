...
import com.dlight.core.network.ApiFailureType.*
...
//
//
//private val ApolloResponse<Operation.Data>.error: ApiFailure?
...
//    }
//
//suspend fun <T> Deferred<ApolloResponse<Operation.Data>>.data(onFailure: (ApiFailure) -> Unit): T? =
